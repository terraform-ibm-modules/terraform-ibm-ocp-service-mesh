...
variable "transit_ingress_custom_annotations" {
  ...
  default     = {}
  nullable    = false
  description = "Istio ingress to customise your ingress LoadBalaner set with var.string = \"other\". Null not allowed. Empty value makes the ingress to get predefined annotations for transit ingress."
}
