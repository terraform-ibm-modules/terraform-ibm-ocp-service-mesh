...
| <a name="input_mesh_config_dns_refresh_rate"></a> [mesh\_config\_dns\_refresh\_rate](#input\_mesh\_config\_dns\_refresh\_rate) | DNS refresh rate for Envoy clusters of type STRICT\_DNS. Configures how frequently Envoy re-resolves DNS for STRICT\_DNS cluster endpoints. Default is 60s when unset. Accepts Go duration strings (e.g. '30s', '5m'). More details at https://github.com/istio-ecosystem/sail-operator/blob/main/docs/api-reference/sailoperator.io.md#meshconfig | `string` | `null` | no |
